...
import HooksContainer1 from './hook1';
...
const HooksForm1 = () => {
    ...
    const handleuseStateChange = (event) => {
        setValueChange(even.target.value);
    }
    ...
    return(
        <div>
            ...
            <br />
            <form onSubmit={ handleuseContextSubmit }>
                <label> React useContext: </label>
                <input id="useContext" onChange={handleuseContextChange} type="text" />
                <button type="submit"> Submit </button>
            </form>
            <br />
