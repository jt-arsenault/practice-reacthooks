// Routing logic, with silent authentication.
...
// Check authorization. If the user passed authorization, render the component. Otherwise, redirect to home page.
...
const Routes = () => {
    ...
    // our router renders each component based on the path passed in
    return(
        <div>
